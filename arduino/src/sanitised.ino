...
void callback(char *topic, byte *payload, unsigned int length)
{
  ...
  if (strcmp(topic, mqtt_topic_subscribe.c_str()) == 0)
  { //if the incoming message is on the command topic...
...
void ScanBLE()
{
  ...
  // Scan for at most 30 seconds (scanning will stop as soon as our device is found).
  pBLEScan->start(30);
  ...
  if (unNoImpedanceCount < 3 && impedance <= 0) // https://github.com/rando-calrissian/esp32_xiaomi_mi_2_hass/pull/2/commits/02b5ce7a416f39f3d03ec222934be112e28b3e7d
  {
