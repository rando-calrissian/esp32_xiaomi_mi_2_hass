# https://raw.githubusercontent.com/wiecosystem/Bluetooth/master/sandbox/huami.health.scale2/body_scales.py
...
class bodyScales:
    ...
    def getFatPercentageScale(self):
        ...
        if self.scaleType == 'xiaomi':
            scales = [
                {'min': 0, 'max': 11, 'female': [
                    12.0, 21.0, 30.0, 34.0], 'male': [7.0, 16.0, 25.0, 30.0]},
                {'min': 12, 'max': 13, 'female': [
                    15.0, 24.0, 33.0, 37.0], 'male': [7.0, 16.0, 25.0, 30.0]},
                {'min': 14, 'max': 15, 'female': [
                    18.0, 27.0, 36.0, 40.0], 'male': [7.0, 16.0, 25.0, 30.0]},
                {'min': 16, 'max': 17, 'female': [
                    20.0, 28.0, 37.0, 41.0], 'male': [7.0, 16.0, 25.0, 30.0]},
                {'min': 18, 'max': 39, 'female': [
                    21.0, 28.0, 35.0, 40.0], 'male': [11.0, 17.0, 22.0, 27.0]},
                {'min': 40, 'max': 59, 'female': [
                    22.0, 29.0, 36.0, 41.0], 'male': [12.0, 18.0, 23.0, 28.0]},
                {'min': 60, 'max': 100, 'female': [
                    23.0, 30.0, 37.0, 42.0], 'male': [14.0, 20.0, 25.0, 30.0]},
            ]

        elif self.scaleType == 'holtek':
            scales = [
                {'min': 0, 'max': 20, 'female': [
                    18, 23, 30, 35], 'male': [8, 14, 21, 25]},
                {'min': 21, 'max': 25, 'female': [
                    19, 24, 30, 35], 'male': [10, 15, 22, 26]},
                {'min': 26, 'max': 30, 'female': [
                    20, 25, 31, 36], 'male': [11, 16, 21, 27]},
                {'min': 31, 'max': 35, 'female': [
                    21, 26, 33, 36], 'male': [13, 17, 25, 28]},
                {'min': 46, 'max': 40, 'female': [
                    22, 27, 34, 37], 'male': [15, 20, 26, 29]},
                {'min': 41, 'max': 45, 'female': [
                    23, 28, 35, 38], 'male': [16, 22, 27, 30]},
                {'min': 46, 'max': 50, 'female': [
                    24, 30, 36, 38], 'male': [17, 23, 29, 31]},
                {'min': 51, 'max': 55, 'female': [
                    26, 31, 36, 39], 'male': [19, 25, 30, 33]},
                {'min': 56, 'max': 100, 'female': [
                    27, 32, 37, 40], 'male': [21, 26, 31, 34]},
            ]
    ...
    def getMuscleMassScale(self):
        if self.scaleType == 'xiaomi':
            scales = [
                {'min': {'male': 170, 'female': 160}, 'female': [
                    36.5, 42.6], 'male': [49.4, 59.5]},
                {'min': {'male': 160, 'female': 150}, 'female': [
                    32.9, 37.6], 'male': [44.0, 52.5]},
                {'min': {'male': 0, 'female': 0}, 'female': [
                    29.1, 34.8], 'male': [38.5, 46.6]},
            ]
        elif self.scaleType == 'holtek':
            scales = [
                {'min': {'male': 170, 'female': 170}, 'female': [
                    36.5, 42.5], 'male': [49.5, 59.4]},
                {'min': {'male': 160, 'female': 160}, 'female': [
                    32.9, 37.5], 'male': [44.0, 52.4]},
                {'min': {'male': 0, 'female': 0}, 'female': [
                    29.1, 34.7], 'male': [38.5, 46.5]}
            ]
    ...
    def getBoneMassScale(self):
        if self.scaleType == 'xiaomi':
            scales = [
                {'male': {'min': 75.0, 'scale': [2.0, 4.2]}, 'female': {
                    'min': 60.0, 'scale': [1.8, 3.9]}},
                {'male': {'min': 60.0, 'scale': [1.9, 4.1]}, 'female': {
                    'min': 45.0, 'scale': [1.5, 3.8]}},
                {'male': {'min': 0.0, 'scale': [1.6, 3.9]}, 'female': {
                    'min': 0.0, 'scale': [1.3, 3.6]}},
            ]
